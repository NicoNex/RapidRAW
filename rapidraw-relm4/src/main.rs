...
/// Generated by `relm4_icons_build::bundle_icons` in build.rs; exposes the
/// bundled gresource bytes + resource prefix for `initialize_icons`. The
/// per-icon name constants go unused (we pass string names to set_icon_name).
#[allow(dead_code)]
mod icon_names {
