// Coupling-cut: android_integration is not part of rapidraw-core. Inline the
// only non-android helper used here (the android-gated code paths are dropped
// because core does not build for android).
#[inline]
